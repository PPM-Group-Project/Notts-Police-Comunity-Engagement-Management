...
class Department(models.Model):
    ...
    departmentDescription = models.CharField(max_length=255, default="")
...
class UserDetails(models.Model):
    ...
    badgeNumber = models.CharField(max_length=100, default="")
    ...
    def isOfficerManager(self):
        if self.department.isOfficerManager : return True
        return False
    def isDepartmentManager(self):
        if self.department.isDepartmentManager : return True
        return False
    def isEventManager(self):
        if self.department.isEventManager : return True
        return False
